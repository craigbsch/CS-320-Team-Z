Configuration files for the auth0 application used for streamlining authentication (identity access management platform we are using to have a more secure and feature-rich login experience).
